...
- Strict typing BOTH sides: Pydantic on backend, .d.ts interfaces on frontend — no `any`, no untyped data
- Backend internals: TypedDict for in-process data, no free dicts
