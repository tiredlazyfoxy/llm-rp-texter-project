...
- `architecture/quick-reference.md` — DB models, API endpoints, generation modes
...
- `plans/CLAUDE.md` — feature folder layout
- Feature 003 (`plans/003.agent_pipeline/`) — original pipeline design
- Feature 005 (`plans/005.prompt_customization/`) — placeholder/tool catalog, default templates
