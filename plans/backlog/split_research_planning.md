...
### 9. `architecture/quick-reference.md`
...
| `architecture/quick-reference.md` | Update generation modes (2/3-stage), pipeline config (model_id, step_types), tools (research factory), SSE events |
| `architecture/backend.md` | Update generation modes, prompt architecture (research prompt), directory structure |
