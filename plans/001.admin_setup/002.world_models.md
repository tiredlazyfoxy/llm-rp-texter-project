# Feature 001 Step 002 — World Models, Documents, Vector Storage, Stats & Rules
...
| `exits` | str (JSON array) \| None | Optional list of connected location IDs (int64 as strings). None = can travel anywhere ("teleport"). Reserved for future movement restrictions — not enforced in feature 001. |
| `created_at` | datetime | |
