...
Each prompt file must include a module docstring with 5 mandatory sections: PURPOSE, USAGE, VARIABLES, DESIGN RATIONALE, CHANGELOG. See `plans/backlog/prompt_tuning.md` for the full documentation standard and example.
